...
impl MouseInputs {
    ...
    pub(crate) fn get_state(&self, mouse_button: MouseButton) -> &MouseState {
        let result_opt = self.mouse_input_map.get(&mouse_button);
...
mod test {
    ...
    use super::{InputAction, MouseInputs, MouseState};
    ...
    fn can_get_left_mouse_state() {
        ...
        let _left_state: &MouseState = MouseInputs::new().get_state(left_button);
    }
    ...
    fn can_reset_inputs() {
        ...
        let mut left_state: &MouseState = binding.get_state(left_button);
        ...
        left_state = binding.get_state(left_button);
